...
static void fastwrite_memory_block(int32_t* csr_base_ptr, int32_t* mem_base_ptr, int nb_of_bytes, int32_t* data){
	write_enable(csr_base_ptr);
...
int epcq_image_main(int argc, char** argv) {
	char * filename = "output_file_auto.rpd";
	int size = 0;
    ...
    fastwrite_memory_block(csr_base_ptr, mem_base_ptr, size, data);
